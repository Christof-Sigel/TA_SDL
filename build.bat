...
cl %CommonCompilerFlags%  ta_sdl_game.cpp Logging.cpp -Fmhandmade.map -LD /link -incremental:no -opt:ref -PDB:handmade_%random%.pdb -EXPORT:GameSetup -EXPORT:CheckResources -EXPORT:GameTeardown -EXPORT:GameUpdateAndRender -libpath:w64/lib OpenGL32.lib Glu32.lib libz.a glew32.lib SDL2.lib
del lock.tmp
