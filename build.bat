...
set CommonCompilerFlags=-O2 -D_CRT_SECURE_NO_WARNINGS -MTd -nologo -fp:fast -fp:except- -EHsc -Gm- -GR- -EHa- -Zo -Oi  -Wall -wd4201 -wd4068 -wd5030 -wd4649 -wd4505 -wd4710  -FC -Z7 -I../w64/include
