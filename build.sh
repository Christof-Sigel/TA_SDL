...
clang++ -std=c++11 -lSDL2 -ggdb -Weverything -lGLEW -lGLU -lGL -lz -lpng ta_sdl_platform.cpp Logging.cpp $IGNORE_WARNINGS -D__CSGL_DEBUG__ -DDLL_NAME=./ta_sdl_game.so -o ta_sdl.new
